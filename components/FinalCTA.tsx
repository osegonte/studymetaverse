        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-[#1a3c5e] rounded-3xl px-6 sm:px-10 py-14 sm:py-16 text-center shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="/match-report" className="px-7 py-3.5 border-2 border-white/40 text-white font-extrabold text-[14px] sm:text-[15px] rounded-xl hover:bg-white/10 transition-colors w-full sm:w-auto text-center">
